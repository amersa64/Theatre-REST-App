...
import reporting.TheatreReport;
import seating.Seat;
...
public class TestTheatreReport {

	@Test
	public void testGetTotal_seats() {
		Theatre.restart();
		...
		TheatreReport tr = new TheatreReport();
		assertEquals(30, tr.getTotal_seats());
	}

	@Test
	public void testGetSold_seats() {
		Theatre.restart();
		Theatre thalia = Theatre.getInstance();
		Patron p1 = new Patron("Jack", "jack@gmail.com", "8593658871", "address @ chicago", "123456789012345", "01/22");
		Section[] theatre1 = new Section[1];
		...
		thalia.donateTicketByTid("3");
		TheatreReport tr = new TheatreReport();
		assertEquals(6, tr.getSold_seats());
	}
