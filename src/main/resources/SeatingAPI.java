...
//			sna[0] = new SectionNameAdapter(SSS.getInstance().getSection_setup().get("Front right"));
//			sna[1] = new SectionNameAdapter(SSS.getInstance().getSection_setup().get("Front center"));
//			sna[2] = new SectionNameAdapter(SSS.getInstance().getSection_setup().get("Front left"));
//			sna[3] = new SectionNameAdapter(SSS.getInstance().getSection_setup().get("Main right"));
//			sna[4] = new SectionNameAdapter(SSS.getInstance().getSection_setup().get("Main center"));
//			sna[5] = new SectionNameAdapter(SSS.getInstance().getSection_setup().get("Main left"));
