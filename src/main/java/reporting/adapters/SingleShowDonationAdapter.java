...
public class SingleShowDonationAdapter {
	...
	public void setSections(SectionDonationAdapter[] sections) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		SingleShowDonationAdapter other = (SingleShowDonationAdapter) obj;
	...
	public String toString() {
		return "SingleShowDonationAdapter [wid=" + wid + ", show_info=" + show_info + ", sections="
