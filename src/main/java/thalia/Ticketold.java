...
//	Section section;
//	Seat seat;
//	public Ticket(Show show, Section section, Seat seat) {
...
//		return "Ticket [tid=" + tid + ", price=" + price + ", status=" + status + ", show=" + show + ", patron_info="
//				+ patron_info + ", section=" + section + ", seat=" + seat + "]";
//	}
//
//
//	
